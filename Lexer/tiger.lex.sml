        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction58(strm, yyNO_MATCH)
                      else yyQ75(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction58(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction58(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
              else yyAction58(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction58(strm, yyNO_MATCH)
                  else yyQ110(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
              else yyAction58(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction58(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction58(strm, yyNO_MATCH)
                  else yyQ114(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
              else yyAction58(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction54(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ37(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                  else yyAction54(strm, yyNO_MATCH)
            else if inp = #" "
              then yyQ37(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
              else yyAction54(strm, yyNO_MATCH)
       ...
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ31(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
                  else yyAction52(strm, yyNO_MATCH)
            else if inp = #" "
              then yyQ31(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
              else yyAction52(strm, yyNO_MATCH)
